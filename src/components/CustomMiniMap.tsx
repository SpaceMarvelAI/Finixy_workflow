...
const MiniMapCanvas: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ctx.lineWidth = 2;
    ctx.strokeRect(1, 1, MINIMAP_WIDTH - 2, MINIMAP_HEIGHT - 2);
    ...
    const offsetX = (MINIMAP_WIDTH - workflowWidth * scale) / 2 - minX * scale;
    const offsetY = (MINIMAP_HEIGHT - workflowHeight * scale) / 2 - minY * scale;
    ...
    const colors: Record<string, string> = {
      parser: '#f59e0b', validator: '#10b981', matcher: '#8b5cf6',
      duplicate: '#ec4899', exception: '#ef4444', billing: '#f59e0b',
      allocator: '#84cc16', aging: '#14b8a6', recon: '#eab308',
      variance: '#f97316', erpsync: '#06b6d4', logger: '#64748b',
      apreporting: '#3b82f6', arreporting: '#10b981',
      reconreporting: '#6366f1', auditreporting: '#8b5cf6',
      orchestrator: '#a855f7', codeagent: '#6366f1', vizagent: '#a855f7',
      sandbox: '#14b8a6', livecode: '#10b981', insight: '#f59e0b',
      datagrid: '#06b6d4', guardrails: '#ef4444', memory: '#64748b',
      trigger: '#8b5cf6', email: '#3b82f6', export: '#6366f1',
      delay: '#eab308', condition: '#f97316', loop: '#ec4899',
      approval: '#f59e0b', code: '#64748b',
    };
...
export const CustomMiniMap: React.FC = () => {
  return (
    <div className="react-flow__panel react-flow__minimap bottom left" style={{ bottom: 16, left: 16 }}>
      <div className="bg-gradient-to-br from-gray-800/95 to-gray-900/95 border-2 border-gray-700 rounded-xl shadow-2xl backdrop-blur-md overflow-hidden p-2">
        <MiniMapCanvas />
      </div>
    </div>
  );
