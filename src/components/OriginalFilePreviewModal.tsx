...
export const OriginalFilePreviewModal: React.FC<
  OriginalFilePreviewModalProps
> = ({ fileData, onClose }) => {
  ...
  const isPDF =
    fileData.type === "application/pdf" || fileData.url.endsWith(".pdf");
  const isImage = fileData.type.startsWith("image/");
  const isExcel =
    fileData.type.includes("spreadsheet") ||
    fileData.url.endsWith(".xlsx") ||
    fileData.url.endsWith(".xls") ||
    fileData.url.endsWith(".csv");
        ...
        <div className="px-6 py-4 border-b flex justify-between items-center bg-white">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 text-white bg-purple-600 hover:bg-purple-700 rounded-lg transition-all flex items-center gap-2 text-sm font-medium shadow-lg"
        ...
        <div className="flex-1 overflow-hidden bg-gray-50 relative">
          {isPDF && (
            <div className="w-full h-full flex flex-col bg-gray-800">
              {/* Try to embed PDF using object tag for better compatibility */}
              <object
                data={fileData.url}
              ...
              <div className="text-center space-y-6 max-w-md">
                ...
                <div>
                  <p className="text-xl text-gray-700 font-bold mb-2">
                    {isExcel ? "Excel File" : "Preview Not Available"}
                  </p>
